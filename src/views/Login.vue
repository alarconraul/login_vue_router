    ...
    <div class="row">
      <form>
        <div class="form-group">
          <input v-model="email" type="text" id="login" class="form-control" name="login" placeholder="login"/>
        </div>
        <div class="form-group">
          <input v-model="pass" type="password" id="password" class="form-control" name="login" placeholder="password"/>
        </div>
